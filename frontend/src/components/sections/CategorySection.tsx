...
import { useBattlesByCategory } from '@/hooks/useBattles'
...
export function CategorySection({ 
  ...
  const { battles, loading, error } = useBattlesByCategory(category || '')
    ...
    return (
      <section className="mb-12">
        ...
        <div className="text-center py-8">
          <p className="text-red-600">Failed to load category battles</p>
        </div>
      </section>
    )
  }
  ...
  if (!battles?.length) {
    return (
      <section className="mb-12">
        ...
        <div className="text-center py-8">
          <p className="text-gray-500">No battles in this category</p>
        </div>
      </section>
    )
  }
