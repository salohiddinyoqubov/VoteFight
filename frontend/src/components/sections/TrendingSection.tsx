...
import { useTrendingBattles } from '@/hooks/useBattles'
...
export function TrendingSection({ 
  ...
  const { battles, loading, error } = useTrendingBattles()
    ...
    return (
      <section className="mb-12">
        ...
        <div className="text-center py-8">
          <p className="text-red-600">Failed to load trending battles</p>
        </div>
      </section>
    )
  }
  ...
  if (!battles?.length) {
    return (
      <section className="mb-12">
        ...
        <div className="text-center py-8">
          <p className="text-gray-500">No trending battles available</p>
        </div>
      </section>
    )
  }
