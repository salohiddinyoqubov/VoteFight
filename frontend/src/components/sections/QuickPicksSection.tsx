...
import { useQuickPicksBattles } from '@/hooks/useBattles'
...
export function QuickPicksSection({ 
  ...
  const { battles, loading, error } = useQuickPicksBattles()
    ...
    return (
      <section className="mb-12">
        ...
        <div className="text-center py-8">
          <p className="text-red-600">Failed to load quick picks battles</p>
        </div>
      </section>
    )
  }
  ...
  if (!battles?.length) {
    return (
      <section className="mb-12">
        ...
        <div className="text-center py-8">
          <p className="text-gray-500">No quick picks battles available</p>
        </div>
      </section>
    )
  }
